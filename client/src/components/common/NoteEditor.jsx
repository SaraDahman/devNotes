...
import { CalendarDays, Folder, MoreHorizontal } from "lucide-react";
...
export default function NoteEditor({ content = "", onChangeContent }) {
  return (
    <div className="flex flex-col h-full w-full bg-background text-foreground">
      <div className="quill-theme-reset overflow-hidden">
        <ReactQuill
          theme="snow"
          value={content}
